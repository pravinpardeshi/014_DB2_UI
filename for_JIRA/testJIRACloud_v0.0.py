...
class JiraClient:
    ...
    def get_priorities(self):
        """
        Retrieve all priorities available in Jira.
    ...
    def update_priority(self, issue_key, priority):
        """
        Update the priority of an existing Jira issue.

        Args:
            issue_key: Issue key e.g. "SCRUM-1".
            priority: Priority name e.g. "Highest", "High",
                      "Medium", "Low", "Lowest",
                      or priority id e.g. "1", "2".

        Example:
            jira.update_priority("SCRUM-1", "High")
            jira.update_priority("SCRUM-1", "1")
        """

        # Jira accepts either priority id or name.
        # If value looks like a numeric id, use id,
        # otherwise use name.
        if str(priority).isdigit():
            priority_field = {"id": str(priority)}
        else:
            priority_field = {"name": priority}
    ...
    def add_comment(self, issue_key, comment):
        ...
        Example:
            jira.add_comment("SCRUM-1", "This is a comment.")
        """
    ...
    def get_comments(self, issue_key):
        ...
        Example:
            comments = jira.get_comments("SCRUM-1")
        """
    ...
    def update_comment(self, issue_key, comment_id, comment):
        ...
        Example:
            jira.update_comment("SCRUM-1", "10000", "Updated comment text.")
        """
        ...
        # or 204 with no content depending on API version.
        if response.status_code == 200:
            return response.json()
    ...
    def delete_comment(self, issue_key, comment_id):
        ...
        Example:
            jira.delete_comment("SCRUM-1", "10000")
        """
